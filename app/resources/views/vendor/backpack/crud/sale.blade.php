		  ...
		  {!! method_field('POST') !!}
		    ...
		    @endif
		      ...
		      @if(view()->exists('vendor.backpack.crud.form_content'))
		      	@include('vendor.backpack.crud.form_content', ['fields' => $crud->fields(), 'action' => 'sale'])
		      @else
		      	@include('crud::form_content', ['fields' => $crud->fields(), 'action' => 'sale'])
		      @endif
...
<!-- <script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        form.addEventListener('submit', (event) => {
            ...
            let fetchUrl = '/api/datasets/'+ entry_id.toString() +'/sale';
          ...
          .then(response => {
            ...
            window.location.href = "https://cloudskin.alternatecno.es/admin/dataset";
