            ...
            <div class="card">
                <div class="card-body">
                    <form class="col-md-12 p-t-10" role="form" method="POST" action="{{ route('backpack.auth.register') }}">
                        ...
                        <div class="form-group">
                            <label for="documento_identidad">Identification Document</label>
                            <input type="file" class="form-control-file" id="documento_identidad" name="documento_identidad" accept="image/*" required>
                        </div>
